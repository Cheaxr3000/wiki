...
Alors, qu'est-ce que exactement le mode de jeu ”Solo”? Basiquement, c'est le mode de jeu qui peut être joué hors-ligne, et en-ligne, par vous-même. Ce mode de jeu n'a aucune limites, vous pouvez jouer n'importe quelle 'beatmaps' que vous avez, utiliser n'importe quelle Modificateur de Jeu (quelque fois appelé ”modificateur de score”) que vous voulez, mettre le jeu en pause quand vous sentez que votre main vous fait mal, et recommencer la 'beatmap' quand vous sentez que votre score ou précision est trop basse. Vous pouvez aussi regarder les classements Local (”This machine”) ou les classements en ligne pour voir les résultats ou regarder les rediffusions en cliquant simplement sur le score. Vous pouvez appuyer sur F2 pour enregistrer une rediffusion du score sur votre ordinateur, grâce à cela vous pouvez avoir le plaisir de cette rediffusion sans avoir à aller la chercher trop loin.

### Multijoueur

Si vous vous sentez un peu seul en jouant au mode ”Solo”, vous pouvez toujours rejoindre une salle multijoueur. Le minimum requis pour entrer dans le salon multijoueur est seulement un compte osu! connecté dans le jeu avec une relativement bonne connexion Internet. Pour y accéder, appuyer sur le bouton ”Multi”. Là-bas, vous pourrez voir plusieurs salles, rangeant de niveaux ”Easy” à ”Insane”. Jouer en multijoueur est une très bonne manière de se faire de nouveaux amis et de rivaliser avec les autres joueurs. Dès que vous rejoignez une salle, vous allez devoir probablement télécharger la 'beatmap' choisie par l'hôte. Appuyez sur ”Click here to download this map” (devrait être du côté droit, dans une fenêtre rouge), votre navigateur s'ouvrira sur la page de la 'beatmap' choisie. Appuyez juste sur le gros bouton ”Download Beatmap” (vous devez être connecté d'abord) et ouvrez le fichier .osz dès que le téléchargement se finit! Ne vous inquiétez pas si vous pensez que le téléchargement est trop lent, la plupart des hôtes attendront que vous finissiez de télécharger et vous demanderont où vous en êtes dans le téléchargement. Ne soyez pas timides, dites leur! Si vous pensez que ça prendra du temps, vous pouvez aussi leur dire de jouer sans vous (le hôte à une commande spéciale pour faire cela, ”Force Start Game”). Le gameplay de multijoueur est un peu différent du	 solo, vous ne pouvez pas pauser le jeu et les mods sont limités pour les joueurs autres que hôte (l'hôte à le privilège total et peut donner la permission pour activer ”Modes Libre”). La fonctionnalité unique de Multijoueur est le ”Tag Co-Op” (ou ”Team Tag Co-op”, qui se fait en équipe) et des matchs d'équipe. Aussi, vous pouvez voir le score de vos opposants/coéquipiers pendant que vous jouez, créant une atmosphère intense pendant que vous essayez de sécuriser votre place tout en haut.
